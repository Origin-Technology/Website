...
#### **10.4. Data Security**  
Licensor is committed to ensuring that any data we collect is kept strictly confidential and secure. Licensor uses a variety of security measures to protect your data against unauthorized access, alteration, or disclosure. Only authorized personnel have access to this information, and Licensor takes all reasonable steps to ensure the safety of the data collected.

#### **10.5. Data Sharing**  
Licensor does not and should not sell, lease, or otherwise distribute your personal information to third parties unless required by law or with Licensee's explicit(written or oral) consent.
...
If you have any questions or concerns about this Privacy Policy or the way we handle your data, please [contact us](https://www.baidu.com).
